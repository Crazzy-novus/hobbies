...
def show_number(x,y,word="",random_number ="",row_number=""):
...
screen.fill(color)
show_number(400,300,"enter the total number of players:")
...
show_number(400,300,"enter the player name:")
...
for i in range(column):
        show_number((i*box_drawn.width)+100+int(box_drawn.width/3),50,user_name[i])

j=0  #just to increment the vaule for loop
for i  in range(0,rows):
    
    show_number(50,(i*box_drawn.height)+75+int(box_drawn.height/2),'',j)
    j+=2
...
while run:
    ...
    for i in range(0,column):
        ...
        show_number(random_text_x,random_text_y,"random number is :",num)
