...
#icon=pygame.image.load('D:\programing\python pratice\prooject\pro.jpg')
    ...
    def create_toy_hand_R(self):
        ...
        for r_ow in range(rows):
            ...
            #up to this    
                box_x=(col_um*box_drawn.width)+100
                box_y=(r_ow*box_drawn.height)+30  
                self.hand_R_start_x  = int(box_x+(box_drawn.width/2))
            ...
            #for legs
                self.leg_R_start_x  = int(box_x+(box_drawn.width/2))
